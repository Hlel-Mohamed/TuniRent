...
import de.tekup.tunirent.config.JwtTokenUtil;
import de.tekup.tunirent.dto.*;
import de.tekup.tunirent.enums.Role;
import de.tekup.tunirent.exception.AccessDeniedException;
import de.tekup.tunirent.exception.InvalidLoginException;
...
import de.tekup.tunirent.service.AuthenticationService;
import de.tekup.tunirent.service.UserService;
import de.tekup.tunirent.service.UserValidator;
import de.tekup.tunirent.utils.SpecificationUtils;
...
public class UserServiceImpl extends PersonServiceImpl<User> implements UserService {
    ...
    public List<PersonDTO> searchUsers(UserSearchRequest searchRequest) {
        ...
        Specification<User> spec = (root, query, cb) -> {
            List<Predicate> predicates = SpecificationUtils.createPersonPredicates(root, cb, searchRequest.getEmail(), searchRequest.getFirstName(), searchRequest.getLastName(), searchRequest.getPhone());
